 ...
 * Purpose: Set go-to-jail and get-out-of-jail conditions
 */
...
int main(int argc, char** argv) {
   ...
   char jchc;    //choose how to get out of jail: roll for doubles, pay $50, or produce get out of jail free card
    ...
    {   if (jail)
        {   turns++;
            ...
            {   
                ...
                cin>>jchc;
                jchc=(jchc>=97?jchc-32:jchc);   //convert lower case to upper case
                switch (jchc)
                {
                    case 'P':
                        money-=50;
